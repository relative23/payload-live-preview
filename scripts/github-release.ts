...
// On main these two types come from scripts/release-gate.ts. The gate runs from
// main's checkout, so this branch carries only the half of the release it runs.
