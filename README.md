...
- **One runtime, every frontend.** One TypeScript runtime compiled to a self-contained inline script of about 32 KB gzip — 26 KB with the lean artifact ([docs/options.md](docs/options.md)); the adapters for Astro, Next.js, SvelteKit and Nuxt only decide when to deliver it.
